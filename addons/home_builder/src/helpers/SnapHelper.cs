...
public static class SnapHelper
{
    ...
    public static Vector3 ToHalfTileCenter(Vector3 hit, float floorBaseY) =>
        new(Mathf.Floor(hit.X * 2f) * 0.5f + 0.25f, floorBaseY - 0.05f, Mathf.Floor(hit.Z * 2f) * 0.5f + 0.25f);
    ...
    public static (int minX, int maxX, int minZ, int maxZ) HalfGridBounds(Vector3 a, Vector3 b)
    {
        int x0 = Mathf.RoundToInt(a.X * 2f - 0.5f);
        int z0 = Mathf.RoundToInt(a.Z * 2f - 0.5f);
        int x1 = Mathf.RoundToInt(b.X * 2f - 0.5f);
        int z1 = Mathf.RoundToInt(b.Z * 2f - 0.5f);
